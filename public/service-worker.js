    ...
    (function () {
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        return (
                          (s = e.sent), (e.next = 6), A({ plugins: o, request: n, mode: 'read' })
                        );
                      case 6:
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 6:
                        ...
                        throw new v('cache-put-with-no-response', { url: N(u.url) });
                      case 10:
                      ...
                      case 18:
                        if (((h = e.sent), !((l = S(o, 'cacheDidUpdate')).length > 0))) {
                          e.next = 26;
                          break;
                        }
                        return (e.next = 23), C({ cacheName: r, matchOptions: s, request: u });
                      case 23:
                      ...
                      case 34:
                        if (
                          ((e.prev = 34), (e.t1 = e.catch(29)), 'QuotaExceededError' !== e.t1.name)
                        ) {
                          e.next = 39;
                          break;
                        }
          ...
          (function (e, t) {
            ...
            if (null != r) {
              ...
              try {
                for (
                  r = r.call(e);
                  !(c = (n = r.next()).done) && (i.push(n.value), !t || i.length !== t);
                  c = !0
                );
              } catch (s) {
                (o = !0), (a = s);
                                  ...
                                  (a.onerror = function () {
                                    ...
                                    (a.onupgradeneeded = function (e) {
                                      n
                                        ...
                                        : 'function' === typeof t._onupgradeneeded &&
                                    ...
                                    (a.onsuccess = function () {
                                      ...
                                      n
                                        ? r.close()
                                        : ((r.onversionchange = t._onversionchange.bind(t)), e(r));
                                    });
                                })
                              );
                            case 4:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                (e.next = 2),
                                this.getAllMatching(t, { query: r, count: n, includeKeys: !0 })
                              );
                            case 2:
                              return (
                                (a = e.sent),
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              for (
                                a = s.length, i = new Array(a > 3 ? a - 3 : 0), c = 3;
                                c < a;
                                c++
                              )
                                i[c - 3] = s[c];
                          ...
                          function (e) {
                            for (;;)
                              switch ((e.prev = e.next)) {
                                case 0:
                                  for (
                                    a = o.length, i = new Array(a > 1 ? a - 1 : 0), c = 1;
                                    c < a;
                                    c++
                                  )
                                    i[c - 1] = o[c];
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 37:
                        throw (
                          ((e.prev = 37),
                          (e.t1 = e.catch(12)),
                          new v('plugin-error-request-will-fetch', { thrownError: e.t1 }))
                        );
                      case 40:
                      ...
                      case 55:
                        ...
                        return (
                          (e.next = 60),
                          w.fetchDidSucceed.call(w, { event: a, request: y, response: m })
                        );
                      case 60:
                        m = e.sent;
                      case 62:
            ...
            t(e, [
              {
                key: '_handleUpgrade',
                value: function (e) {
                  var t = e.target.result.createObjectStore(V, { keyPath: 'id' });
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (e.next = 2),
                                  this._db.transaction(V, 'readwrite', function (e, n) {
                                    var a = e
                                        .objectStore(V)
                                        .index('timestamp')
                              ...
                              case 7:
                                ...
                                return (o = c.value), (e.next = 11), this._db.delete(V, o.id);
                              case 11:
                                a.push(o.url);
                              case 12:
                                e.next = 7;
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 7:
                                return (
                                  (r = e.sent), (e.next = 10), self.caches.open(this._cacheName)
                                );
                              case 10:
                              ...
                              case 14:
                                ...
                                return (c = i.value), (e.next = 18), n.delete(c);
                              case 18:
                                e.next = 14;
                                break;
                              case 20:
                              ...
                              case 28:
                                0,
                                  ...
                                  this._rerunRequested &&
                                    ((this._rerunRequested = !1), I(this.expireEntries()));
                              case 31:
                              case 'end':
                                return e.stop();
                            }
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (e.next = 3), this._timestampModel.setTimestamp(t, Date.now())
                                );
                              case 3:
                              case 'end':
                                return e.stop();
            ...
            t(e, [
              {
                ...
                value: function (e) {
                  ...
                  return t || ((t = new Z(e, this._config)), this._cacheExpirations.set(e, t)), t;
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  try {
                    for (n.s(); !(t = n.n()).done; ) {
                      ...
                      if (this._urlsToCacheKeys.has(o) && this._urlsToCacheKeys.get(o) !== c)
                      ...
                      if ('string' !== typeof a && a.integrity) {
                        if (
                          ...
                          throw new v('add-to-cache-list-conflicting-integrities', { url: o });
                            ...
                            switch ((e.prev = e.next)) {
                                ...
                                try {
                                  for (u.s(); !(f = u.n()).done; )
                                    (h = W(f.value, 2)),
                                      (l = h[0]),
                                      (p = h[1]),
                                      s.has(p) ? i.push(l) : a.push({ cacheKey: p, url: l });
                                } catch (g) {
                                  u.e(g);
                                } finally {
                                  u.f();
                              ...
                              case 16:
                                return (
                                  ...
                                  e.abrupt('return', { updatedURLs: d, notUpdatedURLs: i })
                                );
                              case 19:
                              case 'end':
                                return e.stop();
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 4:
                                ...
                                return (
                                  (e.next = 10),
                                  f.cacheWillUpdate({ event: i, request: s, response: u })
                                );
                              case 10:
                          ...
                          function (r) {
                            for (;;)
                              switch ((r.prev = r.next)) {
                                case 0:
                                  return (
                                    (a = n.request), (r.prev = 1), (r.next = 4), e.matchPrecache(a)
                                  );
                                case 4:
                                  if (!(i = r.sent)) {
                                    r.next = 7;
            ...
            for (;;)
              switch ((d.prev = d.next)) {
                ...
                case 8:
                  ...
                  return ((s = new URL(o.href)).pathname += n), (d.next = 13), s.href;
                case 13:
                  if (!a) {
                    d.next = 18;
                    break;
                  }
                  return ((u = new URL(o.href)).pathname += '.html'), (d.next = 18), u.href;
                case 18:
                  if (!i) {
                    d.next = 37;
                    break;
                ...
                value: function (e) {
                  ...
                  if (a.protocol.startsWith('http')) {
                    ...
                    if ((!s && this._defaultHandler && (s = this._defaultHandler), s)) {
                      ...
                      0;
                      try {
                        u = s.handle({ url: a, request: r, event: n, params: c });
                      } catch (f) {
                        u = Promise.reject(f);
                      }
                      return (
              ...
              },
              {
                ...
                value: function (e) {
                  if (!this._routes.has(e.method))
                    throw new v('unregister-route-but-not-found-with-method', { method: e.method });
                  var t = this._routes.get(e.method).indexOf(e);
                  if (!(t > -1)) throw new v('unregister-route-route-not-registered');
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 23:
                                ...
                                throw new v('no-response', { url: n.url, error: c });
                              case 26:
      ...
      self.addEventListener('activate', function () {
        ...
        (function (e) {
          oe().addToCacheList(e),
            e.length > 0 &&
              (self.addEventListener('install', ve), self.addEventListener('activate', de));
        })([
          { revision: '024c95d8d305fd48f1bc9ed9081fdf0a', url: '/index.html' },
          { revision: null, url: '/static/css/main.76738b43.css' },
          { revision: null, url: '/static/js/main.803e1c8a.js' },
          { revision: null, url: '/static/media/Audiowide-Regular.2017bdb174a62d0daa3e.ttf' },
          { revision: null, url: '/static/media/CircularStd-Bold.5c4514a8399ec0064b9b.otf' },
          { revision: null, url: '/static/media/CircularStd-Medium.9ffafeddf192e8c8a111.otf' },
          { revision: null, url: '/static/media/GothamMedium.0a910c0b9d50be6aa3dc.ttf' },
          { revision: null, url: '/static/media/Mister.Beat.0945c7077755c9023b64.png' },
          { revision: null, url: '/static/media/avatar.33800973e33f5e250438.jpg' },
          { revision: null, url: '/static/media/default-img.60c3b279d12e8c69f1d5.png' },
          { revision: null, url: '/static/media/logo.7628efd02053ca2562b7.png' },
        ]),
        pe(_e);
      var Le,
        qe = new RegExp('/[^/?]+\\.[^/]+$');
      ke(function (e) {
        ...
        }, new Ee({ cacheName: 'images', plugins: [new ee({ maxEntries: 50 })] })),
